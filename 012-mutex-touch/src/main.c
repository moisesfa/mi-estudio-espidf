/*
En este ejemplo, habilitaremos interrupciones en dos de los canales del sensor táctil para 
contar los toques en los pines e imprimir estadísticas en una tarea periódica de FreeRTOS. 
Para  ello utilizamos dos cables de conexión con clavijas macho. Simplemente se conectan 
a GPIO32 (Touch 9) y GPIO33 (Touch 8) del devkit ESP32.En este ejemplo, habilitaremos 
interrupciones en dos de los canales del sensor táctil para contar los toques en los pines 
e imprimir estadísticas en una tarea periódica de FreeRTOS. Para  ello utilizamos dos cables 
de conexión con clavijas macho. Simplemente se conectan a GPIO32 (Touch 9) y GPIO33 (Touch 8) del devkit ESP32.
*/
